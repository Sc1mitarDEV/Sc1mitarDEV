...
local Window = OrionLib:MakeWindow({Name = "DarkHallowX | DOORS 👁️", HidePremium = false, IntroEnabled = false,IntroText = "Doors Supported!",SaveConfig = true, ConfigFolder = "DarkHallowCF"})
